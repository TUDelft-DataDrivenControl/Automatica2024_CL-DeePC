\begin{tikzpicture}
    ...
    % black diagonals
    \draw[dash pattern=on 1pt off 2pt, line width=0.1pt] ([xshift= 1/2*\onelen,yshift=\dy+5/2*\onelen]M1stair1A) -- ([xshift=-5/2*\onelen,yshift=\dy-1/2*\onelen]M1stair1I);
    \draw[dash pattern=on 1pt off 2pt, line width=0.1pt] ([xshift= 1/2*\onelen,yshift=\dy+3/2*\onelen]M1stair1A) -- ([xshift=-3/2*\onelen,yshift=\dy-1/2*\onelen]M1stair1I);
    \draw[dash pattern=on 1pt off 2pt, line width=0.1pt] ([xshift= 1/2*\onelen,yshift=\dy+1/2*\onelen]M1stair1A) -- ([xshift=-1/2*\onelen,yshift=\dy-1/2*\onelen]M1stair1I);
    \draw[dash pattern=on 1pt off 2pt, line width=0.1pt] ([xshift= 1/2*\onelen,yshift=\dy-1/2*\onelen]M1stair1A) -- ([xshift= 1/2*\onelen,yshift=\dy-1/2*\onelen]M1stair1I);
    \draw[dash pattern=on 1pt off 2pt, line width=0.1pt] ([xshift= 3/2*\onelen,yshift=\dy-1/2*\onelen]M1stair1A) -- ([xshift= 3/2*\onelen,yshift=\dy-1/2*\onelen]M1stair1I);
    \draw[dash pattern=on 1pt off 2pt, line width=0.1pt] ([xshift= 5/2*\onelen,yshift=\dy-1/2*\onelen]M1stair1A) -- ([xshift= 5/2*\onelen,yshift=\dy-1/2*\onelen]M1stair1I);
    \draw[dash pattern=on 1pt off 2pt, line width=0.1pt] ([xshift= 7/2*\onelen,yshift=\dy-1/2*\onelen]M1stair1A) -- ([xshift= 7/2*\onelen,yshift=\dy-1/2*\onelen]M1stair1I);
    \draw[dash pattern=on 1pt off 2pt, line width=0.1pt] ([xshift= 9/2*\onelen,yshift=\dy-1/2*\onelen]M1stair1A) -- ([xshift= 9/2*\onelen,yshift=\dy-1/2*\onelen]M1stair1I);
    \draw[dash pattern=on 1pt off 2pt, line width=0.1pt] ([xshift=11/2*\onelen,yshift=\dy-1/2*\onelen]M1stair1A) -- ([xshift= 9/2*\onelen,yshift=\dy-3/2*\onelen]M1stair1I);
    \draw[dash pattern=on 1pt off 2pt, line width=0.1pt] ([xshift=13/2*\onelen,yshift=\dy-1/2*\onelen]M1stair1A) -- ([xshift= 9/2*\onelen,yshift=\dy-5/2*\onelen]M1stair1I);
    \draw[dash pattern=on 1pt off 2pt, line width=0.1pt] ([xshift=15/2*\onelen,yshift=\dy-1/2*\onelen]M1stair1A) -- ([xshift= 9/2*\onelen,yshift=\dy-7/2*\onelen]M1stair1I);
    }
    ...
    \node[left,text=gray!60,align=center] at ([xshift=0.5mm,yshift=-0.18cm]Zp.center) {\scriptsize{\shortstack{$=$\\$\mathcal{Z}_{i,p,N}$}}};
    ...
    \node[below] at (mat3.center) {$\begin{bmatrix}
        U_{\hat{i},p,f}\\U_{\hat{i}_p,1,f}\\Y_{\hat{i},p,f}\\ \hline Y_{\hat{i}_p,1,f}
    \end{bmatrix}$};
    ...
    \node[right,text=gray!60] at ([yshift=-0.18cm]Zf.center) {\scriptsize{\shortstack{$=$\\$\mathcal{Z}_{\hat{i},1,f}$}}};
