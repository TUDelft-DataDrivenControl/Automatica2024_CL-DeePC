...
\title{Closing the Loop on Data-Enabled Predictive Control using Instrumental Variables\thanksref{footnoteinfo}} % Title, preferably not more 
                                                % than 10 words.
...
\input{sections/2_prelim}
\input{sections/3_CL_DeePC}
\input{sections/4_SolutionMethods}
\input{sections/5_CL_Issue}
\input{sections/6_EquivalenceCLSPC}
