...
figure();
l1 = semilogy(Re_all,costs_DeePC1(idx_median,:),   Color=color{1},LineWidth=2.5); hold on;
l11= semilogy(Re_all,costs_DeePC2,Color=color{1},  LineStyle='--',LineWidth=1.5);
l2 = semilogy(Re_all,costs_CLDeePC1(idx_median,:), Color=color{2},LineWidth=2.5);
...
grid on
xlabel('$\sigma^2(e_k)$','Interpreter','latex');
