...
#SBATCH --output=./Job${index}/d_Re.%A_%a.out
#SBATCH --error=./Job${index}/d_Re.%A_%a.err
#SBATCH --array=1-120
...
matlab -nosplash -nodesktop -r "varying_noise_level(${index},\$SLURM_ARRAY_TASK_ID),quit"
...
cd ${HOME}/../../scratch/${USER}/Automatica_2023/src/d_Re
