...
\begin{align}
    ...
    \end{bmatrix}=\mathcal{O},
\end{align}
with $\varepsilon_1=\Gamma_s(\tilde{A}^p+\tKp{y}\Gamma_p)$, $\varepsilon_2=\Gamma_s(\tKp{u}+\tKp{y}\mathcal{T}_p^\mathrm{u})$, and $\varepsilon_3=\Gamma_s\tKp{y}\mathcal{H}_p$. By inspection, the range of the underbraced matrix $\mathfrak{B}$ is equal to the nullspace of $\mathfrak{R}$: $\mathcal{R}(\mathfrak{B})=\mathcal{N}(\mathfrak{R})$. If the matrix post-multiplying $\mathfrak{B}$ is full row rank then the range of this product is also equal to the nullspace of $\mathfrak{R}$.
