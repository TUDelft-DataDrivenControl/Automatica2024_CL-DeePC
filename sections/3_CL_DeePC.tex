...
\end{align}
with $\varepsilon_1=\Gamma_s(\tilde{A}^p+\tKp{y}\Gamma_p)$, $\varepsilon_2=\Gamma_s(\tKp{u}+\tKp{y}\mathcal{T}_p^\mathrm{u})$, and $\varepsilon_3=\Gamma_s\tKp{y}\mathcal{H}_p$. By inspection, the range of the underbraced matrix $\mathfrak{B}$ is equal to the nullspace of $\mathfrak{R}$ and it contains the range of the product $\mathfrak{B}\mathfrak{D}$: $\mathcal{N}(\mathfrak{R})=\mathcal{R}(\mathfrak{B})\supseteq\mathcal{R}(\mathfrak{B}\mathfrak{D})$.
