...
\begin{align}\label{eq:Dg}
    ...
    \end{bmatrix}.
\end{align}
This is written more compactly for consecutive time indices with $G$ containing consecutive vectors $\{g_{k-\hat{i}+1}\}_{k=\hat{i}}^{\hat{i}+f-1}$, and without the top and bottom matrix equations in \eqref{eq:Dg}, this proves statement~(\ref{claim:G_exists}).
