...
In this section \ac{CL-DeePC} is first introduced and compared to regular \ac{DeePC}. Moreover, an intuitive explanation is offered for contributions \ref{contribution:solves_CL_issue}-\ref{contribution:sample_efficient}. More rigorous demonstrations follow in subsequent sections.
