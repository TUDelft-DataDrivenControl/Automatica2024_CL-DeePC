...
\begin{align}\label{eq:PE_covU}
    ...
    \end{bmatrix}^\top > 0,
\end{align}
which is equivalent to the positive definiteness of an experimental correlation matrix that can be decomposed into its constituent components. By considering Schur components it can be shown that \eqref{eq:PE_covUE} is satisfied if both
\begin{align}
    \widehat{\Sigma}_{u,u} &> 0,\label{eq:PE_covU}\\
    \widehat{\Sigma}_{e,e} - \widehat{\Sigma}_{u,e} \widehat{\Sigma}_{u,u}\inv \widehat{\Sigma}_{u,e}^\top&>0,
\end{align}
in which $\widehat{\Sigma}_{u,e}=U_{i,p+s+n,q-n}E_{i,p+s+n,q-n}^\top$, and likewise for $\widehat{\Sigma}_{u,u}$ and $\widehat{\Sigma}_{e,e}$. Note that 
% ==============================================================================================================================================================
% ==============================================================================================================================================================
