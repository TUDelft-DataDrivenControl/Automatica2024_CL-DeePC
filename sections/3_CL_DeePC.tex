...
\end{lem}
This yields the following corollary for extensions to non-deterministic systems, in which we note that controllability of $(A,B)$ implies controllability of $(A,[B\,K])$.
\setcounter{thm}{0}
\begin{cor}
