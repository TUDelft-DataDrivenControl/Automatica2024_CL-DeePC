...
\begin{lem}\cite{Kailath1980}\label{lem:ineq_Sylvester}
...
%%%%%%%%%%%%%%%%%%%%%%%% Proof of (i) %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\textbf{Proof of $\mathrm{\mathbf{(i)}}$:} 
...
\begin{enumerate}
    \item $\mathcal{R}(\mathfrak{BD}_N)=\mathcal{N}(\mathfrak{R})$, and
    \item $\mathcal{R}(\mathfrak{BD}_f)\subseteq\mathcal{N}(\mathfrak{R})$.
\end{enumerate}
...
Firstly, since ${\mathcal{R}(\mathfrak{BD}_f)\subseteq\mathcal{R}(\mathfrak{B})=\mathcal{N}(\mathfrak{R})}$ condition condition (2) is proven.

Secondly, by similar reasoning, it must hold that ${\mathcal{R}(\mathfrak{BD}_N)\subseteq\mathcal{R}(\mathfrak{B})=\mathcal{N}(\mathfrak{R})}$. To prove condition (1) it must therefore be shown that $\mathcal{R}(\mathfrak{BD}_N)=\mathcal{R}(\mathfrak{B})$, which is the case when $\mathfrak{D}_N$ is full row rank.
