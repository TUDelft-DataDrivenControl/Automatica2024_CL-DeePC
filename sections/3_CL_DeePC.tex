...
\end{align*}
with $\mathfrak{R}\in\mathbb{R}^{sl\times n+(p+s)(r+l)+sl}$, and $\mathfrak{BD}$ as indicated for brevity. Similarly, decomposing the right hand side matrix into contributions from exogenous inputs and initial states using \eqref{eq:DataEq1} for $Y_{k,p,q}$ and $Y_{k_p,s,q}$ obtains
\begin{align}
    \mathfrak{R}
    \underbrace{\begin{bmatrix}
        I_n      & 0      & 0       & 0 & 0\\
