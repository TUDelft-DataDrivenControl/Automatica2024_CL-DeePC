...
\end{align*}
with $\mathfrak{R}$, and $\mathfrak{BD}$ as indicated for brevity. Similarly, using \eqref{eq:DataEq1} to decompose $\mathfrak{BD}$ into a matrix of exogenous inputs and initial states $\mathfrak{D}$ and a matrix to describe their effects $\mathfrak{B}$ obtains
\begin{align}
    \mathfrak{R}
    \underbrace{\begin{bmatrix}
        I_n      & 0      & 0       & 0 & 0\\
