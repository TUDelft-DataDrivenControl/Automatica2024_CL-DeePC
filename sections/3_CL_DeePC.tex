...
\begin{thm}\label{theorem:main_result}
    Consider the minimal discrete non-deterministic \ac{LTI} system given by~\eqref{eqn:SS_innovation}. If the sequence of inputs $\{u_k\}_{k=i}^{i+p+s+N-2}$ is persistently exciting of order $p+s+n$, 
