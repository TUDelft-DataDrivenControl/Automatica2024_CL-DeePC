...
\begin{align}\label{eq:Dg}
    ...
    \end{bmatrix}.
\end{align}
For consecutive initial states, with $k={\hat{i},\dots,\hat{i}+f-1}$, and without the top and bottom matrix equations in \eqref{eq:Dg}, this proves statement~(\ref{claim:G_exists}).
