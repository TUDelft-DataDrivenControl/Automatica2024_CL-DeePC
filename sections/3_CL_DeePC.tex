...
\begin{thm}\label{theorem:main_result}
    ...
    \begin{enumerate}
        ...
        \item[2)] with a corresponding output predictor $\widehat{Y}_{\hat{i}_p,s,f}$
        \begin{enumerate}
            \item that is uniquely determined by the past data and noise realizations%that uniquely specifies an output predictor
