...
\begin{align}\label{eq:Dg}
    ...
    \end{bmatrix}.
\end{align}
Equation~\eqref{eq:Theorem1} is obtained by sequential application of \eqref{eq:Dg} for $k={\hat{i},\dots,\hat{i}+f-1}$ without the top and bottom matrix equations, such that the resulting future outputs resemble predictions and $G$ contains the vectors $\{g_{k-\hat{i}+1}\}_{k=\hat{i}}^{\hat{i}+f-1}$.%
%
