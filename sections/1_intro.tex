...
Since its conception in~\cite{Coulson2019}, a form of direct data-driven control called \ac{DeePC} has seen considerable development. \ac{DeePC} makes use of an impo Willems' Fundamental Lemma~\cite{Willems2005} from the field of behavioural systems theory, which states that any sufficiently persistently exciting input-output trajectory parameterizes all possible input-output trajectories
