...
For non-deterministic systems, the parameterization described by Willems' Fundamental Lemma in terms of input-output trajectories is incomplete (and thus often inconsistent) since it disregards the effects of noise. To handle noise for data-, several approaches have been considered in the literature, including averaging~\cite{,}, regularization, 
