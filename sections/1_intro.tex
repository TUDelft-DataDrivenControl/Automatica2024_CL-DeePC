...
To handle noise in direct data-driven methods, several approaches have been considered in the literature, including averaging techniques~\citep{Jo2022}, singular value based thresholding~\citep{Sassella2022}, regularization~\citep{Coulson2019}, the use of maximum likelihood estimation~\citep{Yin2023}, and \ac{IVs}~\citep{vanWingerden2022}.
