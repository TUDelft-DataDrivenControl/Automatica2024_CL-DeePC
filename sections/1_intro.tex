...
\begin{enumerate}
    \item solves the closed-loop identification problem, \label{contribution:solves_CL_issue}
    \item implicitly enforces a causal multi-step ahead predictor model, and \label{contribution:causality}
    \item is particularly sample-efficient, \label{contribution:sample_efficient}
\end{enumerate}
