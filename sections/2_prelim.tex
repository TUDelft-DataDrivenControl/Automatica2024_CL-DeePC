...
The dynamics of the system to be controlled  are described by a non-deterministic discrete \ac{LTI} system that is affected by both process and measurement noise as
