...
\usepackage{amssymb} % for some math symbols like \because

\usepackage[backend=bibtex,style=elsarticle-harv]{biblatex}
\addbibresource{docs/manuscript/autosam.bib}
