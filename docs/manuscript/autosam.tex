...
\title{Closed-loop Data-Enabled Predictive Control and its equivalence with Closed-loop Subspace Predictive Control\thanksref{footnoteinfo}} % Title, preferably not more 
                                                % than 10 words.
...
% \printbibliography % use for biblatex
