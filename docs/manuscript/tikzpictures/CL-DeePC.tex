\begin{tikzpicture}
    ...
    \draw[decorate, decoration={calligraphic brace, amplitude=3pt, mirror, aspect=0.73},line width=1pt] (Brace1L) -- (Brace1R);
    \node (mat1) at ($(Brace1L)!0.73!(Brace1R) + (0,-3pt)$) {};
    \node[below] at (mat1.center) {$\begin{bmatrix}
        U_{i,p,N_\mathrm{s}}\\U_{i_p,1,N_\mathrm{s}}\\Y_{i,p,N_\mathrm{s}}\\ \hline Y_{i_p,1,N_\mathrm{s}}
    \end{bmatrix}$};
    % brace to the left
    ...
    % \node[left,text=gray!100,align=center] at ([xshift=0.5mm,yshift=-0.18cm]Zp.center) {\scriptsize{\shortstack{$=$\\$\Psi_{i,1,N}$}}};
    ...
    \node[below] at (mat3.center) {$\begin{bmatrix}
        U_{\hat{i},p,f}\\U_{\hat{i}_p,1,f}\\\overline{Y}_{\hat{i},p,f}\\ \hline \widehat{Y}_{\hat{i}_p,1,f}
    \end{bmatrix}$};
    ...
    % \node[right,text=gray!100] at ([yshift=-0.18cm]Zf.center) {\scriptsize{\shortstack{$=$\\$\Psi_{\hat{i},1,f}$}}};
